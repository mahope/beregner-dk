      ...
      <article className="prose dark:prose-invert max-w-none">
        ...
        <p>
          ...
          <Link href="/boligstoette" className="text-blue-600 hover:underline">boligstøtte</Link>
           . Vores standardinterval er en forenklet vurdering, mens Udbetaling Danmark beregner din konkrete ret.
        </p>
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-400 p-4 my-6 not-prose">
          ...
          <p className="text-blue-700 dark:text-blue-400">
            ...
            Se også <Link href="/boligstoette" className="underline font-medium">standardmaksima og formuegrænser for boligstøtte</Link>.
          </p>
        </div>
