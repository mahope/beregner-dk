    ...
    <div className="flex flex-col lg:flex-row gap-8">
      <div className="flex-1 min-w-0">
        ...
        <div className="mt-12 prose dark:prose-invert max-w-none">
          <h2>Planl&aelig;g dit bryllupsbudget</h2>
          <p>
            Et bryllup er en af livets st&oslash;rste fester — og en af de <strong>dyreste</strong>. Ved at <strong>planl&aelig;gge budgettet tidligt</strong> kan du prioritere det, der betyder mest for jer, og undg&aring; ubehagelige overraskelser.
          </p>

          <h2>Typiske udgiftsposter</h2>
          <p>
            <strong>Mad og drikke</strong> er den klart st&oslash;rste post. <strong>Venue</strong> varierer enormt — fra gratis i en privat have til 35.000+ kr. for et slot. <strong>Fotograf</strong> er en investering i minder og b&oslash;r ikke spares v&aelig;k.
          </p>

          <h2>Sparetips til brylluppet</h2>
          <ul>
            <li><strong>V&aelig;lg lavs&aelig;son:</strong> Vinter og hverdage er markant billigere</li>
            ...
            <li><strong>Priorit&eacute;r:</strong> V&aelig;lg 2-3 ting der virkelig betyder noget, og spar p&aring; resten</li>
          </ul>
        </div>
        )}
