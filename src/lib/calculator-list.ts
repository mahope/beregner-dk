...
const calculatorDefs: CalculatorDef[] = [
  ...
  { href: "/pension", icon: "👴", titles: { da: "Pension", no: "Pensjon", se: "Pension" }, descriptions: { da: "Beregn din pension", no: "Beregn pensjonen din", se: "Beräkna din pension" } },
  ...
  { href: "/husleje", icon: "🔑", titles: { da: "Husleje", no: "Husleie", se: "Hyra" }, descriptions: { da: "Beregn rimelig husleje", no: "Beregn rimelig husleie", se: "Beräkna rimlig hyra" } },
