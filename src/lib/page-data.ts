...
const daPages: Record<string, PageData> = {
    ...
    "bmi": {
      ...
      metaDescription: "Beregn dit BMI på 5 sekunder. Eksempel: 75 kg / 1,75m = BMI 24,5 (normal). BMI-formlen justeres ikke for alder og er beregnet til voksne.",
...
const noPages: Record<string, PageData> = {
    "bmi": {
      ...
      metaDescription: "Beregn BMI på 5 sekunder. Eksempel: 75 kg / 1,75m = BMI 24,5 (normal). BMI-formelen justeres ikke for alder og er beregnet for voksne.",
      ...
      { question: "Gjelder BMI for barn?", answer: "Denne kalkulatoren er kun for voksne (18+). Den beregner rå BMI, men ikke barns persentil. For barn må du bruke alders- og kjønnsspesifikke persentiltabeller." },
...
const sePages: Record<string, PageData> = {
    ...
    "bmi": {
      ...
      metaDescription: "Beräkna ditt BMI på 5 sekunder. Exempel: 75 kg / 1,75m = BMI 24,5 (normalt). BMI-formeln justeras inte för ålder och är avsedd för vuxna.",
