...
const daPages: Record<string, PageData> = {
    ...
    "alder": {
      ...
      { question: "Kan jeg beregne alder mellem to datoer?", answer: "Ja. Værktøjet har to felter: fødselsdato og 'Beregn alder pr. dato'. Udfylder du begge, tæller det hele år, måneder og dage frem til den dato, du vælger — født 15. marts 1990 giver 20 år, 1 måneder og 16 dage pr. 1. maj 2010." },
      { question: "Hvor gammel var jeg den 1. maj 2010?", answer: "Født 15. marts 1990 var du 20 år, 1 måneder og 16 dage den 1. maj 2010. Sæt 'Beregn alder pr. dato' til den dato, du vil se alderen på." },
...
const sePages: Record<string, PageData> = {
    ...
    "alder": {
      ...
      { question: "Kan jag beräkna ålder mellan två datum?", answer: "Ja. Kalkylatorn har två fält: födelsedatum och 'Beräkna ålder per datum'. Fyller du i båda räknar den hela år, månader och dagar fram till det datum du väljer — född 15 mars 1990 ger 20 år, 1 månader och 16 dagar per 1 maj 2010." },
      { question: "Hur gammal var jag den 1 maj 2010?", answer: "Född 15 mars 1990 var du 20 år, 1 månader och 16 dagar den 1 maj 2010. Sätt 'Beräkna ålder per datum' till det datum du vill se åldern på." },
    ...
    "leasing": {
      ...
      { question: "Vad är färetagsleasing och vad kostar det?", answer: "Färetagsleasing är det vanliga namnet på leasing av bil i Sverige. Kalkylatorn räknar ut månadskostnaden av bilpris, kontantinsats, ränta, restvärde och löptid: en bil på 300.000 kr med 150.000 kr i restvärde, 4,5 % ränta, 30.000 kr i kontantinsats och 36 månader ger 4.121 kr i leasingkostnad per månad. Den räknar inte ut skatten, eftersom det beror på om leasingen drivs i näringsverksamhet eller privat." },
