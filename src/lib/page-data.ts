...
const daPages: Record<string, PageData> = {
    ...
    "dato": {
      ...
      description: "Vælg en startdato og en slutdato. Se straks antal dage, hele uger, ca. måneder, arbejdsdage og weekenddage mellem datoerne.",
      metaTitle: "Beregn antal dage mellem to datoer | MinBeregner.dk",
      metaDescription: "Beregn antal dage mellem to datoer. Vælg start- og slutdato, og se dage, hele uger, ca. måneder, arbejdsdage og weekenddage.",
      keywords: ["datoberegner", "antal dage mellem to datoer", "dage mellem datoer", "beregn dage", "arbejdsdage beregner", "tilføj dage til dato", "dato kalkulator"],
      ogTitle: "Beregn antal dage mellem to datoer | MinBeregner.dk",
      ogDescription: "Beregn antal dage mellem to datoer. Vælg start- og slutdato, og se dage, hele uger, ca. måneder, arbejdsdage og weekenddage.",
      category: "Hverdag",
      breadcrumbCategory: "Hverdag",
      breadcrumbCategoryHref: "/kategori/hverdag",
      schemaName: "Datoberegner",
      schemaDescription: "Beregn antal dage mellem to datoer, hele uger, ca. måneder og arbejdsdage.",
      schemaCategory: "UtilitiesApplication",
      faqItems: [
      { question: "Hvordan beregner jeg dage mellem to datoer?", answer: "Vælg start- og slutdato. Beregneren viser dage, hele uger, ca. måneder og arbejdsdage." },
...
const sePages: Record<string, PageData> = {
    ...
    "dato": {
      ...
      description: "Välj ett startdatum och ett slutdatum. Se direkt antal dagar, hela veckor, ungefärligt antal månader och arbetsdagar mellan datumen.",
      metaTitle: "Beräkna antal dagar mellan två datum | Beräknare.se",
      metaDescription: "Beräkna antal dagar mellan två datum. Välj start- och slutdatum, och se dagar, hela veckor, ungefärligt antal månader och arbetsdagar.",
      keywords: ["datumkalkylator", "antal dagar mellan två datum", "dagar mellan datum", "beräkna dagar", "arbetsdagar kalkylator", "lägg till dagar", "datumräknare"],
      ogTitle: "Beräkna antal dagar mellan två datum | Beräknare.se",
      ogDescription: "Beräkna antal dagar mellan två datum. Välj start- och slutdatum, och se dagar, hela veckor, ungefärligt antal månader och arbetsdagar.",
      category: "Vardag",
      breadcrumbCategory: "Vardag",
      breadcrumbCategoryHref: "/kategori/hverdag",
      ...
      schemaCategory: "UtilitiesApplication",
      faqItems: [
      { question: "Hur beräknar jag dagar mellan två datum?", answer: "Välj start- och slutdatum. Kalkylatorn visar dagar, hela veckor, ungefärligt antal månader och arbetsdagar." },
