...
const sePages: Record<string, PageData> = {
    ...
    "moms": {
      ...
      metaDescription: "Beräkna svensk moms på 25 %. Lägg till 1 000 kr. och få 1 250 kr. Dra av moms eller hitta momsandelen.",
      keywords: ["moms", "momskalkylator", "kalkylator", "gratis", "2026"],
      ogTitle: "Momskalkylator – inkl. och exkl. moms | Beräknare.se",
      ogDescription: "Beräkna svensk moms på 25 %. Lägg till 1 000 kr. och få 1 250 kr. Dra av moms eller hitta momsandelen.",
      category: "Ekonomi",
      breadcrumbCategory: "Ekonomi",
      breadcrumbCategoryHref: "/kategori/oekonomi",
      schemaName: "Momskalkylator",
      schemaDescription: "Gratis momskalkylator. Beräkna svensk moms på 25 % med priser inkl. och exkl. moms.",
      schemaCategory: "FinanceApplication",
      faqItems: [
