...
export const beregnere: BeregnerItem[] = [
  ...
  { title: "Sparemål", description: "Hvor meget skal du spare op om måneden?", href: "/sparemaal", icon: "🎯", category: "Økonomi" },
  { title: "Lønstigning", description: "Beregn lønstigning i procent og kroner", href: "/loenstigning", icon: "💹", category: "Økonomi" },
  ...
  { title: "Ægløsningsberegner", description: "Find dine frugtbare dage og din ægløsning", href: "/aegloesning", icon: "🌸", category: "Familie" },
  ...
  { title: "Rejsebudget Beregner", description: "Beregn rejsebudget til populære destinationer", href: "/rejsebudget", icon: "✈️", category: "Hverdag" },
  { title: "Studielån Beregner", description: "Beregn tilbagebetaling af SU-lån", href: "/studielaan", icon: "🎓", category: "Uddannelse" },
  { title: "Bryllupsbudget", description: "Beregn komplet bryllupsbudget", href: "/bryllup", icon: "💒", category: "Familie" },
  { title: "Skattefradrag Beregner", description: "Beregn alle skattefradrag samlet", href: "/skattefradrag", icon: "📋", category: "Økonomi" },
  ...
  { title: "Ohms lov", description: "Beregn spænding, strøm, modstand og effekt", href: "/ohm", icon: "⚡", category: "Matematik" },
  { title: "Vægt på planeterne", description: "Se din vægt på Månen, Mars og de andre planeter", href: "/planetvaegt", icon: "🪐", category: "Matematik" },
