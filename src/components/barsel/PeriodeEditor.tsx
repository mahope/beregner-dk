...
export default function PeriodeEditor({ plan, analyse, opdater }: Props) {
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[minmax(0,22rem)_1fr]">
      <form onSubmit={anvend} className="space-y-3 rounded-xl border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-900/40 print:hidden" aria-labelledby="periode-titel">
        <h4 id="periode-titel" className="font-semibold text-gray-900 dark:text-white">
          Tilføj eller ret en periode
        </h4>
