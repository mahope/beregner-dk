    ...
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 md:p-8">
          ...
          {result ? (
            <div className="space-y-4">
              ...
              <div className="bg-white dark:bg-gray-700 rounded-lg p-4 shadow-sm">
                <div className="text-sm text-gray-500 dark:text-gray-400">Ugentlig sats (før skat)</div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-white dark:bg-gray-700 rounded-lg p-3 shadow-sm">
                  <div className="text-xs text-gray-500 dark:text-gray-400">Månedligt (før skat)</div>
                  <div className="text-lg font-semibold text-gray-900 dark:text-white">
                    {result.monthlyAmount.toLocaleString('da-DK')} kr.
                  </div>
                </div>
                <div className="bg-white dark:bg-gray-700 rounded-lg p-3 shadow-sm">
                  <div className="text-xs text-gray-500 dark:text-gray-400">Månedligt (efter skat)</div>
      ...
      <div className="grid md:grid-cols-2 gap-4 mt-6">
        ...
        <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-4">
          <h4 className="font-semibold text-green-800 dark:text-green-300 mb-2">💡 Tip</h4>
